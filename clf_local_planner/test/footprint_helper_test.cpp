...
public:
  ...
  void correctLineCells() {
    std::vector<clf_local_planner::Position2DInt> footprint;
  ...
  void correctFootprint(){
    ...
    std::vector<clf_local_planner::Position2DInt> footprint = fh.getFootprintCells(pos, footprint_spec, map, false);
